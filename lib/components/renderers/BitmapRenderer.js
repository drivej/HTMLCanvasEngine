...
exports.BitmapRenderer = void 0;
function BitmapRenderer(sprite, context, canvas, camera) {
    ...
    */
    ...
    context.save();
    context.globalAlpha = sprite.projection.alpha;
    context.drawImage(sprite.canvas, sprite.projection.x, sprite.projection.y, sprite.projection.width, sprite.projection.height);
    context.restore();
}
